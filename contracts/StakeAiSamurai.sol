...
contract StakeAiSamurai is UntransferableERC721, IERC721Receiver {
    ...
    constructor(
        ...
        uint256 _rate
    ) UntransferableERC721("StakeAiSamurai", "sAIS") {
    ...
    function _findRate() private view returns (uint256 rate) {
        ...
        // 12000 blocks per day
        // perDay / 12000 = reward per block
        // on earlier iterations there was an error stating 6000 blocks per day however that was for eth chain, theta runs more or less twice as fast @ 12000 blocks per day so that was corrected and will be the metric moving forward for any additional staking contracts
        rate = (perDay * 1e18) / 12000;
        return rate;
    }
